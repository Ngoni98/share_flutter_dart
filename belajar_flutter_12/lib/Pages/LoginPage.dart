...
class _LoginPageState extends State<LoginPage> {
  ...
  Container buildButtonSosMed(IconData icon, Color iconColor) {
    return Container(
      child: InkWell(
        onTap: () {},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      key: _formKey,
      child: ListView(
        padding: const EdgeInsets.fromLTRB(22.0, 0.0, 22.0, 22.00),
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              buildButtonSosMed(GroovinMaterialIcons.google, Colors.blue),
              SizedBox(width: 16.0),
              buildButtonSosMed(
                  GroovinMaterialIcons.facebook, Colors.blue.shade800),
              SizedBox(width: 16.0),
              buildButtonSosMed(GroovinMaterialIcons.twitter, Colors.lightBlue),
            ],
          ),
          SizedBox(height: 60.0),
          buildDaftar()
